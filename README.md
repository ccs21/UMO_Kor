...
이미 한국어판 beta.1~beta.8을 사용 중인 경우에는 합본 ZIP을 다시 받을 필요 없이 릴리스의 `UMO_Kor-1.1.17-ko-beta.9.apk`만 받아 기존 앱을 삭제하지 않고 덮어 설치하세요. APK 단독 파일은 신규 설치자의 데이터 서버를 포함하지 않습니다.
